...
{
    [DbContext(typeof(Db))]
    [Migration("20240528181759_TaskToIngestForegnKey")]
    partial class TaskToIngestForegnKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AiCoreApi.Models.DbModels.LoginModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            LoginId = 1,
                            Created = new DateTime(2024, 5, 28, 18, 17, 58, 478, DateTimeKind.Utc).AddTicks(7893),
                            CreatedBy = "system",
