...
{
    [DbContext(typeof(Db))]
    [Migration("20240531161005_IngestionConnections")]
    partial class IngestionConnections
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AiCoreApi.Models.DbModels.LoginModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            LoginId = 1,
                            Created = new DateTime(2024, 5, 31, 16, 10, 5, 152, DateTimeKind.Utc).AddTicks(6912),
                            CreatedBy = "system",
