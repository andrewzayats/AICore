...
{
    [DbContext(typeof(Db))]
    [Migration("20240723135839_StaticAgentsContent")]
    partial class StaticAgentsContent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AiCoreApi.Models.DbModels.LoginModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            LoginId = 1,
                            Created = new DateTime(2024, 7, 23, 13, 58, 38, 660, DateTimeKind.Utc).AddTicks(3128),
                            CreatedBy = "system",
